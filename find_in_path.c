 ...
 * @data: a pointer tothe program's data
...
/**
 * check_file - checks exists a filed, it is not diarectory and
 * if it has excecution permisions for this permisions.
 * @full_path: pointer to the full file named
